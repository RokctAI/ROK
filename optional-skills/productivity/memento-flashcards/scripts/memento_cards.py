...
Data file: $ROK_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ROK_HOME = Path(os.environ.get("ROK_HOME", Path.home() / ".rok"))
DATA_DIR = _ROK_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
