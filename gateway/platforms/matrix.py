...
# Uses get_rok_home() so each profile gets its own Matrix store.
from rok_constants import get_rok_dir as _get_rok_dir
_STORE_DIR = _get_rok_dir("platforms/matrix/store", "matrix/store")
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(os.getenv("ROK_MATRIX_TEXT_BATCH_DELAY_SECONDS", "0.6"))
        self._text_batch_split_delay_seconds = float(os.getenv("ROK_MATRIX_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0"))
