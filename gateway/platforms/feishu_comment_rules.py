...
Config: ~/.rok/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.rok/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_rok_home()`` helper (ROK_HOME-aware and
...
RULES_FILE = get_rok_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_rok_home() / "feishu_comment_pairing.json"
