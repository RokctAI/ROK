# Streaming LLM Response Support for Rok Agent
...
```
ROK_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ROK_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `rok_cli/config.py` | 1 | +streaming config defaults |
