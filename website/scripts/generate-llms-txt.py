#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Rok docs site.
...
Both publish at:
  https://rok.rokct.ai/docs/llms.txt
  https://rok.rokct.ai/docs/llms-full.txt
...
SITE_BASE = "https://rok.rokct.ai/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Rok as a Python Library", None),
        ("guides/use-mcp-with-rok", "Use MCP with Rok", None),
        ("guides/use-voice-mode-with-rok", "Use Voice Mode with Rok", None),
        ("guides/use-soul-with-rok", "Use SOUL.md with Rok", None),
        ("guides/build-a-rok-plugin", "Build a Rok Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Rok"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/Rokctai/"
        "rok-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/RokctAI/rok-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Rok Agent — Full Documentation\n",
        (
            "This file is the entire Rok Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Rok, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://rok.rokct.ai/docs\n",
        "Short index: https://rok.rokct.ai/docs/llms.txt\n",
        "\n---\n\n",
    ]
