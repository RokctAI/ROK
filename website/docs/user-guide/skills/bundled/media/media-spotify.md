...
Control the user's Spotify account via the Rok Spotify toolset (7 tools). Setup guide: https://rok.rokct.ai/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `rok auth spotify` again.
