...
```python
import sys
sys.path.insert(0, "/home/teknium/.rok/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.rok/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Rok installs package this)
