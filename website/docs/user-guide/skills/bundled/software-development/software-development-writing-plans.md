...
| Version | `1.1.0` |
| Author | Rok Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For Rok:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Rok tools to understand the project:
