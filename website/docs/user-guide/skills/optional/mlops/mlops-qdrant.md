...
| | |
|---|---|
| Source | Optional — install with `rok skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/RokctAI/rok-agent/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/RokctAI/rok-agent/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
