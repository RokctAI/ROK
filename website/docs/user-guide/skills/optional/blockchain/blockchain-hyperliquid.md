...
| | |
|---|---|
| Source | Optional — install with `rok skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Rok Agent |
| License | MIT |
...
The script reads `~/.rok/.env` for two optional defaults:
...
Helper script: `~/.rok/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.rok/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.rok/.env`.
...
```bash
python3 ~/.rok/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.rok/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
