...
| | |
|---|---|
| Source | Optional — install with `rok skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Rok Agent |
| License | MIT |
...
Helper script path: `~/.rok/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.rok/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.rok/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.rok/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
