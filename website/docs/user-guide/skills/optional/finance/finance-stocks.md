...
| | |
|---|---|
| Source | Optional — install with `rok skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Rok Agent |
| License | MIT |
...
```
SCRIPT=~/.rok/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.rok/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
