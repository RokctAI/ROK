...
| | |
|---|---|
| Source | Optional — install with `rok skills install official/health/neuroskill-bci` |
...
Connect Rok to a running [NeuroSkill](https://neuroskill.com/) instance to read
