...
| | |
|---|---|
| Source | Optional — install with `rok skills install official/research/qmd` |
...
Rok Agent via the native MCP client. This is the preferred
...
Then configure Rok Agent to connect via HTTP:
