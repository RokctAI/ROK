...
| | |
|---|---|
| Source | Optional — install with `rok skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Rok Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ROK_OSINT_CACHE/icij/ (default: ~/.cache/rok-osint/icij/).
...
# Set ROK_OSINT_UA=your-app/1.0 (your@email) to identify yourself
