...
description: "Build wrapper CLIs that extend the Rok TUI with custom widgets, keybindings, and layout changes"
---
...
Called after Rok registers its own keybindings and before the layout is built. Add your keybindings to `kb`.
