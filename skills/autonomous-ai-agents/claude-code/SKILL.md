...
metadata:
  rok:
    ...
    related_skills: [codex, rok-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the Rok terminal. Claude Code is Anthropic's autonomous coding agent CLI.
