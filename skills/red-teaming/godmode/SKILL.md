...
exec(open(os.path.expanduser(
    "~/.rok/skills/red-teaming/godmode/scripts/load_godmode.py"
)).read())
...
exec(open(os.path.expanduser("~/.rok/skills/red-teaming/godmode/scripts/parseltongue.py")).read())
...
```python
# Via execute_code
exec(open(os.path.expanduser("~/.rok/skills/red-teaming/godmode/scripts/godmode_race.py")).read())
