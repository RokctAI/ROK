...
| Change | Upstream | Rok |
|--------|----------|--------|
| Metadata namespace | `openclaw` | `rok` |
...
| File operations | Bash commands | Rok file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Rok-specific adaptations.
