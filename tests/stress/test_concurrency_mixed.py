...
def worker_loop(worker_id: int, rok_home: str, result_file: str) -> None:
...
def reclaimer_loop(rok_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="rok_mixed_stress_")
    print(f"ROK_HOME = {home}")
