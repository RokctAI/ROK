...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("rok_cli.config.get_config_path", return_value=config_path), \
             patch("rok_cli.config.ensure_rok_home"):
    ...
    def test_ensure_rok_home_sets_0700(self):
        home = Path(self.tmpdir) / ".rok"
        with patch("rok_cli.config.get_rok_home", return_value=home):
