...
class TestParserRegistry:
    ...
    def test_rok_parser_registered(self):
        parsers = list_parsers()
        assert "rok" in parsers
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["rok"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use rok format since that's universal
