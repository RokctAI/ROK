...
class TestResolveApiKeyProviderCredentials:
    ...
    def test_try_gh_cli_token_uses_homebrew_path_when_not_on_path(self, monkeypatch):
        monkeypatch.setattr("rok_cli.auth.shutil.which", lambda command: None)
        monkeypatch.setattr(
            "rok_cli.auth.os.path.isfile",
            lambda path: path == "/opt/homebrew/bin/gh",
        )
        monkeypatch.setattr(
            "rok_cli.auth.os.access",
        ...
        monkeypatch.setattr("rok_cli.auth.subprocess.run", _fake_run)
