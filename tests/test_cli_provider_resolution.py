...
def test_model_flow_nous_prints_subscription_guidance_without_mutating_explicit_tts(monkeypatch, capsys):
    ...
    monkeypatch.setattr("rok_cli.auth._prompt_model_selection", lambda model_ids, current_model="": "claude-opus-4-6")
...
def test_cmd_model_falls_back_to_auto_on_invalid_provider(monkeypatch, capsys):
    ...
    monkeypatch.setattr(rok_main, "_prompt_provider_choice", lambda choices: len(choices) - 1)
...
def test_cmd_model_forwards_nous_login_tls_options(monkeypatch):
    ...
    monkeypatch.setattr(rok_main, "_prompt_provider_choice", lambda choices: 0)
