...
These tests verify the contract between rok-agent's environments/ code
...
class TestManagedServerAPI:
    """Test that ManagedServer's API matches what rok-agent expects."""
...
class TestParserCompatibility:
    """Test that rok-agent's parsers match ManagedServer's expectations."""
...
class TestBaseEnvCompatibility:
    ...
    def test_rok_base_env_sets_server_manager_tool_parser(self):
        ...
        base_env_path = Path(__file__).parent.parent / "environments" / "rok_base_env.py"
