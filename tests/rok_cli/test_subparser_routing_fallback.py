...
The main() function in rok_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `rok -c model`
...
def _build_parser():
    """Build a minimal replica of the rok top-level parser."""
