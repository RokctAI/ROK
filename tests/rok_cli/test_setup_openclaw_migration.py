...
class TestOfferOpenclawMigration:
    ...
    def test_skips_when_no_openclaw_dir(self, tmp_path):
        ...
        with patch("rok_cli.setup.Path.home", return_value=tmp_path):
            assert setup_mod._offer_openclaw_migration(tmp_path / ".rok") is False
    ...
    def test_skips_when_migration_script_missing(self, tmp_path):
        ...
        openclaw_dir.mkdir()
        with (
            patch("rok_cli.setup.Path.home", return_value=tmp_path),
    ...
    def test_skips_when_user_declines(self, tmp_path):
        ...
        openclaw_dir = tmp_path / ".openclaw"
        openclaw_dir.mkdir()
        script = tmp_path / "openclaw_to_rok.py"
    ...
    def test_runs_migration_when_user_accepts(self, tmp_path):
        ...
        # Create a fake rok home with config
        ...
        fake_mod = ModuleType("openclaw_to_rok")
        ...
        fake_migrator.migrate.return_value = {
            ...
            "output_dir": str(rok_home / "migration"),
        }
        ...
        with (
            ...
            result = setup_mod._offer_openclaw_migration(rok_home)
    ...
    def test_creates_config_if_missing(self, tmp_path):
        ...
        with (
            ...
            setup_mod._offer_openclaw_migration(rok_home)
...
class TestGetSectionConfigSummary:
    ...
    def test_gateway_lists_platforms(self):
        ...
        # reads from rok_cli.gateway.get_env_value after the setup
    ...
    def test_gateway_matches_platform_registry(self):
        ...
        from rok_cli.gateway import _PLATFORMS
