...
class TestReadFullLog:
    ...
    def test_reads_small_file(self, rok_home):
        from rok_cli.debug import _read_full_log
    ...
    def test_returns_none_for_empty(self, rok_home):
