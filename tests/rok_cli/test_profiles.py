...
class TestExportImport:
    ...
    def test_export_default_excludes_infrastructure(self, profile_env, tmp_path):
        ...
        for d in ("rok", ".worktrees", "profiles", "bin",
        ...
        excluded_prefixes = [
            "default/rok", "default/.worktrees", "default/profiles",
...
class TestCompletion:
    ...
    def test_bash_completion_has_rok_profiles_function(self):
        script = generate_bash_completion()
        assert "_rok_profiles" in script

    def test_zsh_completion_has_rok_function(self):
        script = generate_zsh_completion()
        assert "_rok" in script
