    ...
    def test_filters_to_current_profile(self, monkeypatch, tmp_path):
        ...
        def fake_run(cmd, **kwargs):
            return subprocess.CompletedProcess(
                cmd, 0,
                stdout=(
                    "100 /Users/dgrieco/.rok/rok/venv/bin/python -m rok_cli.main --profile orcha gateway run --replace\n"
                    "200 /Users/dgrieco/.rok/rok/venv/bin/python -m rok_cli.main --profile other gateway run --replace\n"
                ),
                stderr="",
            )
