...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from rok_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ROK_OVERLAYS
        overlay = ROK_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify rok doctor recognizes Xiaomi env vars."""
