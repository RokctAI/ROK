...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "rok_approve_once" in action_ids
        assert "rok_approve_session" in action_ids
        assert "rok_approve_always" in action_ids
        assert "rok_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "rok_deny", "value": "session-key"}
