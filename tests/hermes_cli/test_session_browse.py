"""Tests for the interactive session browser (`rok sessions browse`).
...
from rok_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """rok sessions browse should be parseable."""
        from rok_cli.main import main as _main_entry
