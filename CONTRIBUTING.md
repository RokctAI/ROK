...
2. **Cross-platform compatibility** — Windows, macOS, different Linux distros, different terminal emulators. We want Rok to work everywhere.
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.rok/.env
```
...
Rok runs on Linux, macOS, and Windows. When writing code that touches the OS:
