...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "rokctai.com"
...
def auth_json_path():
    """Return the Rok auth store path, respecting ROK_HOME overrides."""
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from rok_cli.auth import resolve_nous_access_token
