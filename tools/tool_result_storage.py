...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/rok-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/rok-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/rok-results"
HEREDOC_MARKER = "ROK_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"ROK_PERSIST_{uuid.uuid4().hex[:8]}"
