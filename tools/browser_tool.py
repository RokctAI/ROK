...
def _find_agent_browser() -> str:
    ...
    # Build an extended search PATH including Homebrew and Rok-managed dirs.
    ...
    if os.path.isdir(rok_node_bin):
        extra_dirs.append(rok_node_bin)
...
def _run_browser_command(
    ...
    try:
        ...
        # Ensure PATH includes Rok-managed Node first, Homebrew versioned
