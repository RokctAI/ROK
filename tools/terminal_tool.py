...
def _handle_sudo_failure(output: str, env_type: str) -> str:
    ...
    """
    is_gateway = os.getenv("ROK_GATEWAY_SESSION")
...
def _transform_sudo_command(command: str | None) -> tuple[str | None, str | None]:
    ...
    if not has_configured_password and not sudo_password and os.getenv("ROK_INTERACTIVE"):
        ...
        if modal_state["selected_backend"] != "direct":
            if modal_state["managed_mode_blocked"]:
                raise ValueError(
                    ...
                    "ROK_ENABLE_NOUS_MANAGED_TOOLS is not enabled and no direct "
