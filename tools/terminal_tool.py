        ...
        if background:
            ...
            try:
                ...
                if check_interval and background:
                    ...
                    watcher_platform = os.getenv("ROK_SESSION_PLATFORM", "")
                    watcher_chat_id = os.getenv("ROK_SESSION_CHAT_ID", "")
                    watcher_thread_id = os.getenv("ROK_SESSION_THREAD_ID", "")
