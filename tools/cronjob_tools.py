...
def _origin_from_env() -> Optional[Dict[str, str]]:
    origin_platform = os.getenv("ROK_SESSION_PLATFORM")
    origin_chat_id = os.getenv("ROK_SESSION_CHAT_ID")
    if origin_platform and origin_chat_id:
        return {
            "platform": origin_platform,
            "chat_id": origin_chat_id,
            "chat_name": os.getenv("ROK_SESSION_CHAT_NAME"),
            "thread_id": os.getenv("ROK_SESSION_THREAD_ID"),
        }
    return None
