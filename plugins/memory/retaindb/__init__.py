...
Config via environment variables:
  ...
  RETAINDB_PROJECT    — Project identifier (default: rok)
"""
...
class RetainDBMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "project", "description": "Project identifier", "default": "rok"},
        ]
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        if explicit_project:
            ...
            # Default profile (~/.rok) → "rok"; named profiles → "rok-<name>"
            if profile_name and profile_name != ".rok":
                self._project = f"rok-{profile_name}"
            else:
                self._project = "rok"
