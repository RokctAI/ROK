...
def cmd_setup(args) -> None:
    ...
    rok_host.setdefault("aiPeer", _host_key())

    # Memory mode
    current_mode = rok_host.get("memoryMode") or cfg.get("memoryMode", "hybrid")
    print("\n  Memory mode options:")
    ...
    if new_mode in ("hybrid", "honcho"):
        rok_host["memoryMode"] = new_mode
    else:
        rok_host["memoryMode"] = "hybrid"
    ...
    print("    per-session   — new Honcho session each run, named by Rok session ID")
    ...
    rok_host.setdefault("enabled", True)
    ...
    print("    rok honcho mode       — show or change memory mode")
    print("    rok honcho tokens     — show or set token budgets")
    print("    rok honcho identity   — seed or show AI peer identity")
...
def cmd_mode(args) -> None:
    ...
    if mode_arg is None:
        ...
        print("\n  Set with: rok honcho mode [hybrid|honcho]\n")
        return
