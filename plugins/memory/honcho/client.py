...
def resolve_config_path() -> Path:
    ...
    default_path = Path.home() / ".rok" / "honcho.json"
...
def _resolve_memory_mode(
    ...
    Object form:  { "default": "hybrid", "rok": "honcho", ... }
...
class HonchoClientConfig:
    ...
    # Config object form: "memoryMode": { "default": "hybrid", "rok": "honcho" }
    ...
    def resolve_session_name(
        ...
        Resolution order:
          ...
          3. per-session strategy — Rok session_id ({timestamp}_{hex})
