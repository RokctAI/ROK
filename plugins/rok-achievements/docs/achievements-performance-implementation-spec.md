# Rok Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.rok/plugins/rok-achievements/state.json` (existing unlock state)
  - `~/.rok/plugins/rok-achievements/scan_snapshot.json` (new)
  - `~/.rok/plugins/rok-achievements/scan_checkpoint.json` (new)
