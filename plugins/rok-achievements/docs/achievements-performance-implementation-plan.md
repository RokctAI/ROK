# Rok Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.rok/plugins/rok-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.rok/plugins/rok-achievements/scan_checkpoint.json`.
