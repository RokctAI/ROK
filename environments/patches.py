"""
Monkey patches for making rok-agent tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by rok_base_env.py).
