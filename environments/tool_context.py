...
ALL rok-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all rok-agent tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any rok-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("ROK_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("ROK_QUIET", None)
            else:
                os.environ["ROK_QUIET"] = _prev_quiet
