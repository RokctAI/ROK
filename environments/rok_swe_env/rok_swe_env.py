"""
RokSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser rok
    run-api
    python environments/rok_swe_env.py serve \\
...
class RokSweEnv(RokBaseEnv):
    ...
    name = "rok-swe"
    env_config_cls = RokSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[RokSweEnvConfig, List[APIServerConfig]]:
        """
