...
# ============================================================================
# Mini-SWE Runner with Rok Trajectory Format
# ============================================================================
...
class MiniSWERunner:
    ...
    def _convert_to_rok_format(
        ...
        """
        Convert internal message format to Rok trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Rok trajectory format
        trajectory = self._convert_to_rok_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Rok trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Rok Trajectory Format")
    print("=" * 60)
