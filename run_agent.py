...
class AIAgent:
    ...
    def __init__(
        ...
        # Rok is a tool-using client by default.
        ...
        # Persistent error log -- always writes WARNING+ to ~/.rok/logs/errors.log
            ...
            if api_key and base_url:
                ...
                if "openrouter" in effective_base.lower():
                    client_kwargs["default_headers"] = {
                        "HTTP-Referer": "https://rok-agent.rokctai.com",
    ...
    def _interruptible_streaming_api_call(
        ...
        def _call_chat_completions():
            ...
            _stream_read_timeout = float(os.getenv("ROK_STREAM_READ_TIMEOUT", 60.0))
            stream_kwargs = {
                **api_kwargs,
                "stream": True,
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        if _is_nous:
            extra_body["tags"] = ["product=rok-agent"]
    ...
    def _handle_max_iterations(self, messages: list, api_call_count: int) -> str:
        ...
        try:
            ...
            if _is_nous:
                summary_extra_body["tags"] = ["product=rok-agent"]
            ...
            while retry_count < max_retries:
                try:
                    ...
                    if (
                        ...
                        print(f"{self.log_prefix}     • Clear stale keys: rok config set ANTHROPIC_TOKEN \"\"")
                        print(f"{self.log_prefix}     • Legacy cleanup: rok config set ANTHROPIC_API_KEY \"\"")
                        ...
                        if self._empty_content_retries < 3:
                            ...
                            if empty_response_info["is_local_custom"]:
                                error_message = (
                                    ...
                                    "Likely causes: wrong /v1 endpoint, runtime context window smaller than Rok expects, "
