...
class _SafeWriter:
    ...
    When rok runs as a systemd service, Docker container, or headless
...
class AIAgent:
            ...
            if api_key and base_url:
                ...
                if "openrouter" in effective_base.lower():
                    client_kwargs["default_headers"] = {
                        "HTTP-Referer": "https://rok.rokctai.com",
                        "X-OpenRouter-Title": "Rok Agent",
                ...
                if not _mem_provider_name:
                    try:
                        ...
                        if _hcfg.enabled and (_hcfg.api_key or _hcfg.base_url):
                            ...
                            try:
                                from rok_cli.config import load_config as _lc, save_config as _sc
                                _cfg = _lc()
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        if not self.skip_context_files:
            ...
            # mode).  The gateway process runs from the rok install
    ...
    def _interruptible_api_call(self, api_kwargs: dict):
        ...
        _stale_base = float(os.getenv("ROK_API_CALL_STALE_TIMEOUT", 300.0))
    ...
    def _interruptible_streaming_api_call(
        ...
        def _call_chat_completions():
            ...
            import httpx as _httpx
            _base_timeout = float(os.getenv("ROK_API_TIMEOUT", 1800.0))
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        api_kwargs = {
            ...
            "timeout": float(os.getenv("ROK_API_TIMEOUT", 1800.0)),
        }
        if self._is_qwen_portal():
            api_kwargs["metadata"] = {
        ...
        elif (self._is_openrouter_url() or "rokctai" in self._base_url_lower) and "claude" in (self.model or "").lower():
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        """
        if "rokctai" in self._base_url_lower:
            return True
    ...
    def _handle_max_iterations(self, messages: list, api_call_count: int) -> str:
        ...
        try:
            ...
            if _is_nous:
                summary_extra_body["tags"] = ["product=rok"]
