 ...
 * `window.__ROK_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Rok brand in the top bar
 ...
 *  `window.__ROK_PLUGINS__.registerSlot(...)`.
 *
