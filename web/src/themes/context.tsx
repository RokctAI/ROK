...
const STORAGE_KEY = "rok-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `rok_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "rok-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-rok-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-rok-theme-font", "true");
