...
def _profile_user_agent() -> str:
    """Return a ``rok-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from rok_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"rok-cli/{_ver}"
    except Exception:
        return "rok-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # rok-cli UA so the catalog endpoint is reachable.
