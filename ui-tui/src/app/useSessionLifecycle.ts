...
import type { ScrollBoxHandle } from '@rok/ink'
import { evictInkCaches } from '@rok/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ROK_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
