...
# Rok effort → Anthropic adaptive-thinking effort (output_config.effort).
    ...
    *base_url* is a Kimi / Moonshot host), unsigned thinking blocks
    ...
    for m in messages:
        ...
        if role == "assistant":
            ...
            # can validate the message history.  See rok-agent#13848.
            #
    ...
    # are preserved.  See rok-agent#13848 (Kimi) and #16748 (DeepSeek).
...
def build_anthropic_kwargs(
    ...
    # silently hides reasoning text that Rok surfaces in its CLI. We
