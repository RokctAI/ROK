...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - rok_home (str): The active ROK_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.rok``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "rok").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'rok memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], rok_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'rok memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``rok_home`` is the active ROK_HOME directory path.
