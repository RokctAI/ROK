#!/usr/bin/env python3
"""Build the Rok Skills Index — a centralized JSON catalog of all skills.
...
`rok skills search/install` can use it without hitting the GitHub API.
...
# Ensure ROK_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Rok Skills Index...", flush=True)
