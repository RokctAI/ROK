#!/usr/bin/env python3
"""Build the Rok Model Catalog — a centralized JSON manifest of curated models.
...
Rok CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Rok release.
...
# Ensure ROK_HOME is set for imports that touch it at module level.
os.environ.setdefault("ROK_HOME", os.path.join(os.path.expanduser("~"), ".rok"))

from rok_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "rok-agent repo",
            "docs": "https://rok.rokct.ai/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
