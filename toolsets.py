...
TOOLSETS = {
    ...
    "rok-gateway": {
        ...
        "tools": [],
        "includes": ["rok-telegram", "rok-discord", "rok-whatsapp", "rok-slack", "rok-signal", "rok-homeassistant", "rok-email", "rok-sms", "rok-mattermost", "rok-matrix", "rok-dingtalk", "rok-feishu", "rok-wecom", "rok-webhook"]
    }
}
