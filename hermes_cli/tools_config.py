...
PLATFORMS = {
    "cli":      {"label": "🖥️  CLI",       "default_toolset": "rok-cli"},
    "telegram": {"label": "📱 Telegram",   "default_toolset": "rok-telegram"},
    "discord":  {"label": "💬 Discord",    "default_toolset": "rok-discord"},
    "slack":    {"label": "💼 Slack",      "default_toolset": "rok-slack"},
    "whatsapp": {"label": "📱 WhatsApp",   "default_toolset": "rok-whatsapp"},
    "signal":   {"label": "📡 Signal",     "default_toolset": "rok-signal"},
    "homeassistant": {"label": "🏠 Home Assistant", "default_toolset": "rok-homeassistant"},
    "email":    {"label": "📧 Email",      "default_toolset": "rok-email"},
    "matrix":   {"label": "💬 Matrix",     "default_toolset": "rok-matrix"},
 "dingtalk": {"label": "💬 DingTalk", "default_toolset": "rok-dingtalk"},
    "feishu": {"label": "🪽 Feishu", "default_toolset": "rok-feishu"},
    "wecom": {"label": "💬 WeCom", "default_toolset": "rok-wecom"},
    "api_server": {"label": "🌐 API Server", "default_toolset": "rok-api-server"},
    "mattermost": {"label": "💬 Mattermost", "default_toolset": "rok-mattermost"},
    "webhook": {"label": "🔗 Webhook", "default_toolset": "rok-webhook"},
}
    ...
    if not env_vars:
        ...
        if managed_feature:
            ...
            if any(get_env_value(env_var) for env_var in override_envs):
                _print_warning(
                    "  Direct credentials are still configured and may take precedence until you remove them from ~/.rok/.env."
                )
        return
