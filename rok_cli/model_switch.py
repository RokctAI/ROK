...
def list_authenticated_providers(
    ...
    from rok_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS
    ...
    for pid, overlay in ROK_OVERLAYS.items():
        ...
        if not has_creds:
            try:
                ...
                if store and (
                    pid in providers_store or rok_slug in providers_store
                    or pid in pool_store or rok_slug in pool_store
                ):
                    has_creds = True
