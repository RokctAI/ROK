...
Usage:
    rok pairing list              # Show all pending + approved users
    rok pairing approve <platform> <code>  # Approve a pairing code
    rok pairing revoke <platform> <user_id> # Revoke user access
    rok pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle rok pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: rok pairing {list|approve|revoke|clear-pending}")
        print("Run 'rok pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.rok/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'rok pairing list' to see pending codes.\n")
