"""
Skills configuration for Rok Agent.
`rok skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.rok/config.yaml under:
...
from rok_cli.platforms import PLATFORMS as _PLATFORMS, platform_label
