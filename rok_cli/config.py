...
def recommended_update_command() -> str:
    ...
    return get_managed_update_command() or "rok update"
...
def format_managed_message(action: str = "modify this Rok installation") -> str:
    ...
    if managed_system == "NixOS":
        ...
        return (
            ...
            "Edit services.rok.settings in your configuration.nix and run:\n"
...
def get_container_exec_info() -> Optional[dict]:
    ...
    container_name = info.get("container_name", "rok")
...
OPTIONAL_ENV_VARS = {
    ...
    "API_SERVER_MODEL_NAME": {
        "description": "Model name advertised on /v1/models. Defaults to the profile name (or 'rok' for the default profile). Useful for multi-user setups with OpenWebUI.",
