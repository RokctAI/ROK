...
TIPS = [
    ...
    # --- Gateway & Messaging ---
    "Rok runs on 18 platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, email, and more.",
    ...
    "BOOT.md at ~/.rok/BOOT.md runs automatically on every gateway start — use it for startup checks.",
