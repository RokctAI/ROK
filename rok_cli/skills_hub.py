    ...
    if not force and not skip_confirm:
        ...
        if bundle.source == "official":
            c.print(Panel(
                ...
                "It ships with rok but is not activated by default.\n"
...
def skills_command(args) -> None:
    ...
    if action == "browse":
        ...
        _console.print("Usage: rok skills [browse|search|install|inspect|list|check|update|audit|uninstall|publish|snapshot|tap]\n")
